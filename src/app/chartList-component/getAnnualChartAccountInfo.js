...
exports.handler = (event, context, callback) => {
	...
	try {
		if (event.method == "POST") {
			...
			var sql= 
			"SELECT za.REPORTDATE, za.FINANCIALREPORTTYPE, za.AMOUNT, za.DOUBLECOUNTED " +
			"FROM ( SELECT a.REPORTDATE, a.FINANCIALREPORTTYPE, b.AMOUNT, b.DOUBLECOUNTED FROM WELLS.FINANCIALREPORT a " +
			...
			"ORDER BY a.REPORTDATE DESC) AS za LIMIT 1";
