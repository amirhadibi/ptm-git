...
exports.handler = (event, context, callback) => {
	...
	try {
		if (event.method == "POST") {
            ...
            var sql= "SELECT a.MAPCODE, a.LITERAL, a.ROLLUPCODE "+
                    "FROM WELLS.CHARTACCOUNT a " +
                    "WHERE a.CHARTCODE = ? and a.FORMCODE=  ? " +
                    "ORDER BY a.ROLLUPCODE";

            var identifier= [event['CHARTCODE'], event['FORMCODE']];
